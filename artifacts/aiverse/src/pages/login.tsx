        ...
        <div className="p-8 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm font-medium text-white/80"
            >
              <GoogleIcon /> Google
            </button>
            <button
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-[#050505] text-white/30">or continue with email</span>
            </div>
          </div>
